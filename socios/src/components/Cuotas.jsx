...
import { Container, TableContainer, Table, TableHeader, TableBody, TableCell, TableHeaderCell } from "./TablesStyles"; // Asegúrate de que el nombre sea correcto
                        ...
                        <Table>
                            <TableHeader>
                                <tr>
                                    ...
                                    <TableHeaderCell>ID Administrador</TableHeaderCell>
                                    ...
                                    <tr key={cuota.ID_Cuota}>
                                        ...
                                        <TableCell>
                                            {cuotaEnEdicion === cuota.ID_Cuota ? (
                                                ...
                                                new Date(cuota.Fecha_Vencimiento).toLocaleDateString()  // Convertimos a formato legible
                                            )}
                                        </TableCell>
                                        <TableCell>{cuota.ID_Administrador}</TableCell>
                                        <TableCell>
                                            {cuotaEnEdicion === cuota.ID_Cuota ? (
                                                <>
                                                    <button onClick={() => handleSave(cuota.ID_Cuota)}>Guardar</button>
