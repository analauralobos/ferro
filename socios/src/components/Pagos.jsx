...
import { Container, Table, TableHeader, TableBody, TableHeaderCell, TableCell, Button, TableContainer } from "./TablesStyles"; // Asegúrate de que el nombre sea correcto
                            ...
                            {sociosFiltrados.map(pago => {
                                ...
                                return (
                                    <tr key={pago.ID_Pago}>
                                        ...
                                        <TableCell>{pago.ID_Administrador}</TableCell>
                                        <TableCell>
